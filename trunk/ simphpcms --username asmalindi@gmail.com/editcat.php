 ...
 include("process.php");
   if(isset($_POST['submit'])) {
    ...
    if (isset($_POST['cat_title'])) {
      ...
      $CategorieM->editCategorie($cati,cat_title,$cat_title);
	} 
    if (isset($_POST['cat_despription'])) {
          $cat_despription =$_POST['cat_despription'];
        $CategorieM->editCategorie($cati,cat_despription,$cat_despription);    
	} 
...
-->         <br /> <br /><br /><br /><br /><br /><br />
            <form id="form_156044" class="appnitro"  method="post" action="editcat.php"> 
    			...
    			<ul > 
    					...
    					<li id="li_3" > 
    		<label class="description" for="cat_id">Drop Down </label> 
    		<div> 
    		<select class="element select medium" id="cat_id" name="cat_id"> 
    			<?php
...
-->
    		...
    		<label class="description" for="cat_title">Title </label> 
    		<div> 
    			<input id="cat_title" name="cat_title" class="element text medium" type="text" maxlength="255" value=""/> 
    		</div> 
    		</li>		<li id="li_2" > 
    		<label class="description" for="cat_despription">Despription </label> 
    		<div> 
    			<textarea id="cat_despription" name="cat_despription" class="element textarea medium"></textarea> 
    		</div> 
    		</li> 
