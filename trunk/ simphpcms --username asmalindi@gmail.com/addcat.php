 ...
 */
 ...
 if(isset($_POST['submit'])) {
    if (isset($_POST['cat_title']) && isset($_POST['cat_despription'])) {
...
<br />
		...
		<form id="form_155828" class="appnitro"  method="post" action="addcat.php">
		...
		<div>
			<input id="cat_title" name="cat_title" class="element text large" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_2" >
		...
		<div>
			<textarea id="cat_despription" name="cat_despription" class="element textarea medium"></textarea> 
				...
				<input id="saveForm" class="button_text" type="submit" name="submit" value="Add Cat" />
		</li>
			</ul>
		</form>	
        </div>
