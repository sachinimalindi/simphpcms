 ...
 $categorie = new Categorie();
  if(isset($_POST['submit'])) {
    ...
    if (isset($_POST['cat_id'])) {
      ...
      $CategorieM->removeCategorie($cati);
	} 
...
<div id="menu">
    <ul class="menu">
        ...
        <div><ul>
                ...
                <li><a href="findSectionCategorie.php"><span>Find sectioncategorie</span></a></li>
                <li><a href="removeSectionCategorie.php"><span>Remove sectioncategorie</span></a></li>
            </ul></div>
        </li>
...
<br />
        ...
        <div id="main">
            ...
            <form  method="post" action="removecat.php"> 
