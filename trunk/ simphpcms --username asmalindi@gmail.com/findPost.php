            ...
            <h2>Column 1</h2>
             <?php
              ...
              echo "<table border='2' cellspacing='2' cellpadding='2'>
                ...
                <th><font face='Arial, Helvetica, sans-serif'>cat</font></th>
                <th><font face='Arial, Helvetica, sans-serif'>link</font></th>
                <th><font face='Arial, Helvetica, sans-serif'>show</font></th>
                <th><font face='Arial, Helvetica, sans-serif'>keyw</font></th>
                <th><font face='Arial, Helvetica, sans-serif'>date</font></th>
                <th><font face='Arial, Helvetica, sans-serif'>order</font></th>
                </tr>";
             $field1=$posts[$y]->getPost_id();
             $field2=$posts[$y]->getPost_title();
             $field3=$posts[$y]->getPost_author();
             $field4=substr($posts[$y]->getPostcontent(),0,10);
             $field5=$posts[$y]->getCategory();
             $field6=$posts[$y]->getLinklabel();
             $field7=$posts[$y]->getShowing();
             $field8=$posts[$y]->getKeywords();
             $field9=$posts[$y]->getC_date();
             $field10=$posts[$y]->getPorder();
             echo "<tr><td>".$field1."</td><td>".$field2."</td><td>".$field3."</td><td>".$field4."</td><td>".$field5."</td><td>".$field6."</td><td>".$field7."</td><td>".$field8."</td><td>".$field9."</td><td>".$field9."</td><td>".$field10."</td></tr>";
              ...
              ?>
              <form  method="post" action="findPost.php">
