...
-->         <br /> <br /><br /><br /><br /><br /><br />
          <form id="form_155828" class="appnitro"  method="post" action="editSectionCategorie.php">
		...
		<div> 
		<select class="element select medium" id="section" name="section"> 
			<?php
             
            $sections=$SectionM->getSectionList();
            
	          for($x=1;($x-1)<sizeof($sections);$x++){
              // $categorie = $CategorieM->getCategories($categories[$y]);
              // $categories[$y]
              // echo $catID[$y];
             //echo "<li><a href='".$catID[$y]."'>".$catID[$y]."</a></li>";
             $field3=$sections[$x]->getSec_id();
             $field4=$sections[$x]->getSec_title();
             echo "<option value=".$field3.">".$field4."</option>";
