...
-->         <br /> <br /><br /><br /><br /><br /><br />
            	<form id="form_155828" class="appnitro"  method="post" action="editSection.php">
			...
			<ul >
		<li id="li_3" > 
    		<label class="description" for="sec_id">Drop Down </label> 
    		<div> 
    		<select class="element select medium" id="sec_id" name="sec_id"> 
    			<?php
