        ...
        <div id="main">
            <h2>Column 1</h2>
             <table border="2" cellspacing="2" cellpadding="2">
                <tr>
                <th><font face="Arial, Helvetica, sans-serif">cat_id</font></th>
                <th><font face="Arial, Helvetica, sans-serif">sec_id</font></th>
                </tr>
             <?php
             
             $sectionCategorie = $sectionCategorieM->getSectionCategorieModels();
	          for($y=1;($y-1)<sizeof($sectionCategorie);$y++){
              // $categorie = $CategorieM->getCategories($categories[$y]);
              // $categories[$y]
              // echo $catID[$y];
             //echo "<li><a href='".$catID[$y]."'>".$catID[$y]."</a></li>";
             $field1=$sectionCategorie[$y]->getCat_id();
             $field2=$sectionCategorie[$y]->getSec_id();
